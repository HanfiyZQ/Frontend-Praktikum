...
const users = [
  ...
  { name: "Ishfani Ghiyath", age: 12, major: "Informatics" },
  { name: "Naruto", age: 15, major: "Political Science" },
  { name: "Sasuke", age: 29, major: "International Relations" },
  { name: "Sakura", age: 29, major: "Medical School" }
];
